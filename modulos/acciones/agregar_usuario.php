...
if(isset($_POST['agregar'])){
  ...
  $sql1 = ("SELECT COUNT(*) FROM usuarios WHERE correo_usuario = :correo");
  $smt1 = $conexion->prepare($sql1);
  $smt1->execute(array(":correo" => $correo));
  ...
  if(empty($correo) || !filter_var($correo, FILTER_VALIDATE_EMAIL)){
    ...
    $error = "Las contraseñas no coinciden";
      ...
      if ($smt1->fetchColumn() > 0){
          ...
          /*$sql2 = "INSERT INTO usuarios(correo_usuario, contraseña_usuario, persona_id)
                   VALUES (:correo, :contraseña, :persona)";
          $smt2 = $conexion->prepare($sql2);
          $smt2->execute(array(":correo" => $correo,
                               ":contraseña" => $passencriptada,
                               ":persona" => $persona));
          */
          $sql2 = $conexion->prepare("INSERT INTO usuarios SET correo_usuario = ?, contraseña_usuario = ?, persona_id = ?");
          $insertar = $sql2->execute([$correo, $passencriptada, $persona]);

          if ($insertar == true){
              $error = "El usuario fue agregado sin problemas";
              $class = "success";
          } else {
...
$sql = $conexion->query("SELECT * FROM personas P WHERE P.persona_id not in(SELECT U.persona_id from usuarios U)");
            ...
            <div class="card-body">
              <form method="POST" onsubmit="return validarUsuario();">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label class="bmd-label-floating">Escribe de nuevo tu contraseña</label>
